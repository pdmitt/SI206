...
# api = tweepy.API(auth)
# public_tweets = api.search('mmlerpotw')
...
# 	s.append(analysis.sentiment.subjectivity) #index 1
# 	p.append(analysis.sentiment.polarity) #index 0
...
public_tweets = api.search('sentiment.lolmom')
